  ...
  return <section>
    <div className='container mx-auto min-h-[800px] mb-14'>
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
        ...
        <div className='mb-4 lg:mb-0 flex gap-x-2 text-xs'>
      ...
      <div className='flex flex-col items-start gap-8 lg:flex-row'>
        <div className='max-w-[768px]'>
          ...
          <div className='flex-x-6 text-violet-700 mb-6'>
        ...
        <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
          ...
          <form className='flex flex-col gap-y-4'>
            <input className='border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-14' placeholder='name' type='text'/>
            <input className='border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-14' placeholder='email' type='text'/>
            <input className='border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-14' placeholder='phone' type='text'/>
            ...
            defaultValue='Hello I am Intrested'></textarea>
